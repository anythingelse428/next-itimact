...
export type CreatePostInput = {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** Text in feed. Field for post mutations */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The excerpt of the object */
  excerpt?: InputMaybe<Scalars['String']['input']>;
  /** Custom field for post mutations */
...
export type CreateUserInput = {
  ...
  userAvatarUrl?: InputMaybe<Scalars['String']['input']>;
...
/** Input for the descriptionMutation mutation. */
export type DescriptionMutationInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  description: Scalars['String']['input'];
};

/** The payload for the descriptionMutation mutation. */
export type DescriptionMutationPayload = {
  __typename?: 'DescriptionMutationPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  description?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the featuredImageUrlMutation mutation. */
export type FeaturedImageUrlMutationInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  featuredImageUrl: Scalars['String']['input'];
};

/** The payload for the featuredImageUrlMutation mutation. */
export type FeaturedImageUrlMutationPayload = {
  __typename?: 'FeaturedImageUrlMutationPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
export type RootMutation = {
  ...
  /** The descriptionMutation mutation */
  descriptionMutation?: Maybe<DescriptionMutationPayload>;
  /** The featuredImageUrlMutation mutation */
  featuredImageUrlMutation?: Maybe<FeaturedImageUrlMutationPayload>;
  /** Increase the count. */
...
/** The root mutation */
export type RootMutationDescriptionMutationArgs = {
  input: DescriptionMutationInput;
};


/** The root mutation */
export type RootMutationFeaturedImageUrlMutationArgs = {
  input: FeaturedImageUrlMutationInput;
};
...
/** The root mutation */
export type RootMutationTestMutationArgs = {
...
/** The template assigned to the node */
export type Template_SinglePageSidebarOnRight = ContentTemplate & {
  __typename?: 'Template_SinglePageSidebarOnRight';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_SinglePostSidebarOnRight = ContentTemplate & {
  __typename?: 'Template_SinglePostSidebarOnRight';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the testMutation mutation. */
export type TestMutationInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  userAvatarUrl: Scalars['String']['input'];
};

/** The payload for the testMutation mutation. */
