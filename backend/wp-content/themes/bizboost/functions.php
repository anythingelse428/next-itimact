...
function add_tag_caps_to_author_role() {
  // получаем объект роли "Автор"
  $role = get_role( 'author' );

  // добавляем разрешение для создания тегов
  $role->add_cap( 'edit_tags' );
  $role->add_cap( 'manage_categories' );
}
add_action( 'admin_init', 'add_tag_caps_to_author_role' );
add_action( 'init', 'add_tag_caps_to_author_role' );
// Add block patterns
